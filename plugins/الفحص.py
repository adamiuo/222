...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "₰ [𝙟𝙢𝙩𝙝𝙤𝙣 𝙖𝙧𝙖𝙗𝙞𝙘 𝙪𝙨𝙚𝙧𝙗𝙤𝙩](t.me/AKJA0) ₰"
...
async def _(event):
    await event.delete()
    AKJA0get = await event.get_sender()
    hnarsl = event.to_id
    AKJA0_pic = "https://telegra.ph/file/7bac18f40e26d091b6720.jpg"
    await sbb_b.send_file(hnarsl, AKJA0_pic, caption=f"اهلا بك {AKJA0get.first_name}\n\n اصدار جمثون: 5.0.0\n اصدار البايثون: {python_version()}\n اصدار التيليثون: {version.__version__}\n\nشكرا لك\nجمثون™")
